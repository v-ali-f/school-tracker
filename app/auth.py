...
NOTIFICATION_DELIVERY_CHANNELS = [
    ("both", "MAX и приложение / PWA", "Уведомления приходят в MAX-бот и push в установленное приложение."),
    ("max", "Только MAX", "Push в приложение / PWA не отправляется."),
    ("app", "Только приложение / PWA", "MAX-бот не получает уведомления."),
]
