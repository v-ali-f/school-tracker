...
def _children_workspace_context():
    from app.services.children_workspace_service import children_workspace_context

    return children_workspace_context()


def _incident_workspace_navigation():
    from app.services.children_workspace_service import workspace_navigation
