...
"""
from app.models_legacy import Document, OrderResponsible, OrderResponsibleLink, SchoolOrder

__all__ = ['Document', 'OrderResponsible', 'OrderResponsibleLink', 'SchoolOrder']
