...
"""
from app.models_legacy import Department, DepartmentLeader, DepartmentSubject, TeacherCourse, TeacherLoad, TeacherMckoResult

__all__ = ['Department', 'DepartmentLeader', 'DepartmentSubject', 'TeacherCourse', 'TeacherLoad', 'TeacherMckoResult']
